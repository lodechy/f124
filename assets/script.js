...
const data = [
    ...
    { date: '24/09/2025', gp_flag: '🇦🇺', gp_name: 'Australie', race_gauvain_pos: 1, race_gauvain_pts: 26, race_galahad_pos: 'DNF', race_galahad_pts: 0, quali_gauvain_pos: 1, quali_gauvain_tps: '1:25.432', quali_galahad_pos: 20, quali_galahad_tps: '-', legendary: false, gp_map: 'https://aurupteur.com/wp-content/uploads/2022/02/Australie-carbon.png' },
...
displayData.forEach((round, i) => {
    ...
    slide.innerHTML = `
        ...
        <div class="mt-1 text-center">
          ...
          ${ round.gp_name === "Portugal" ? `<span class="bg-red-100 text-red-800 text-xs font-medium px-1.5 py-0.5 rounded-sm dark:bg-red-900 dark:text-red-300">Bonus</span>` : `` }
        </div>
